"""
ConfigMap class for managing Kubernetes ConfigMaps in K8s-Gen DSL.
    ...
    def generate_kubernetes_resources(self) -> List[Dict[str, Any]]:
        ...
        if self._hot_reload:
            config_map["metadata"]["annotations"].update({
                "k8s-gen.io/hot-reload": "true",
                "k8s-gen.io/restart-policy": self._hot_reload_config.get("restart_policy", "rolling"),
                "k8s-gen.io/check-interval": self._hot_reload_config.get("interval", "30s")
            })
