"""
Utility helper functions for K8s-Gen.

This module contains common utility functions used throughout the K8s-Gen package
...
def generate_annotations(**annotations) -> Dict[str, str]:
    ...
    """
    base_annotations = {
        "k8s-gen.io/generated": "true",
        "k8s-gen.io/version": "1.0.0",
    }
